...
class Robot:
    ...
    def check_collision_config(
        ...
        # The below code link to link collision checking
        # for i in range(len(robot_edges)):
        #     for j in range(i + 1, len(robot_edges)):
        #         edge1_start = robot_edges[i][0]
        #         edge1_end = robot_edges[i][1]
        #         edge2_start = robot_edges[j][0]
        #         edge2_end = robot_edges[j][1]
        #         if edge1_end == edge2_start:
        #             def direction_vector(segment):
        #                 return (segment[1][0] - segment[0][0], segment[1][1] - segment[0][1])
        #             direction1 = direction_vector(robot_edges[i])
        #             direction2 = direction_vector(robot_edges[j])

        #             # Normalize the direction vectors
        #             length1 = (direction1[0]**2 + direction1[1]**2)**0.5
        #             length2 = (direction2[0]**2 + direction2[1]**2)**0.5

        #             normalized_direction1 = (direction1[0] / length1, direction1[1] / length1)
        #             normalized_direction2 = (direction2[0] / length2, direction2[1] / length2)

                    
        #             # Check if the normalized direction vectors are collinear
        #             if (normalized_direction1[0] == -normalized_direction2[0] and
        #                     normalized_direction1[1] == -normalized_direction2[1]):
        #                 print(normalized_direction1, normalized_direction2)
        #                 return True
        #         else:
        #             if is_intersecting([robot_edges[i]], [robot_edges[j]]):
        #                 return True
        return False
